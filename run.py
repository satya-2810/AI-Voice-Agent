...
def check_dependencies():
    ...
    required_packages = ["fastapi", "uvicorn", "requests", "python-multipart"]
    ...
    if missing_packages:
        ...
        logger.error(
            "Please install missing packages using: pip install "
...
def check_directories():
    ...
    required_dirs = [settings.temp_dir, settings.static_dir, settings.templates_dir]
